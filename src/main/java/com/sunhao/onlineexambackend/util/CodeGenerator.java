package com.sunhao.onlineexambackend.util;//package com.sunhao.onlineexambackend.util;
//
...
//                    builder.parent("com.sunhao") // 设置父包名
//                            .moduleName("onlineexambackend") // 设置父包模块名
...
//                    builder.addInclude("user", "question", "paper", "exam", "score", "message", "reply")// 设置需要生成的表名
